...
try:
    ...
    print(f"{G}[{R}!{G}] Bahan Belum Terinstall{abu}...")
    time.sleep(5)
    print(f"{G}[{R}!{G}] Type{R}:{Y}pip{W} install colorama requests")
...
def mr_wibu():
    mr_tytyd = input(f"{G}Arep ngerjani maning!!! {putih}({G}y{W}/{Y}n{putih}){R}:{W} ")
    if mr_tytyd=="y" or mr_tytyd=="Y":
        time.sleep(5)
        put()
    if mr_tytyd=="n" or mr_tytyd=="N":
        sys.exit(f"{W}[{R}!{W}] Wis rampung coy!{biru}....{W}")
        time.sleep(5)
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
<<<<<<>>>>BREBES
<<<<<>>>\033[1;91m\033[1;41m\033[1;97m NURDIN: Pagejugan\033[;0m\033[1;91m\033[1;92m
""")
    except requests.exceptions.ConnectionError:
        sys.exit(f"{G}[{R}!{G}] Eror Cek Jaringan{abu}....{abu}")
    except KeyboardInterrupt:
        sys.exit(f"{G}[{R}!{G}] Kluar{abu}...{W}")
...
def put():
    ...
    try:
        ...
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m Nomere pira boss \033[1;33m• \033[0m\033[1;30m]══════════════>")
        mengetik("\033[37m[\033[31m•\033[37m]\033[32m Contoh nomor\033[37m : \033[37m\033[33m8*****\033[33m")
        mr_am=input(f"\n\033[37m[\033[31m•\033[37m]\033[32m Nomor Target Sing pan di kerjani\033[32m \033[37m:\033[37m\033[33m ")
        mengetik("\033[1;30m<════════════[\033[1;33;41m • \033[1;37m KAREPE PING PIRA \033[1;33m• \033[0m\033[1;30m]═════════════>")
        power_python=int(input(f"\033[37m[\033[31m•\033[37m]\033[32m Ping pira\033[37m :\033[37m\033[33m "))
        print ("")
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam Call Ke No {Y}{mr_am}")
            else:
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam Call Ke No {R}{mr_am}")
            time.sleep(1)
            ...
            if "Berhasil Ngab" in gas:
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam WA Ke No {R}{mr_am}")
            else:
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam WA Ke No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "ok" in dekor2:
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam Sms Ke No {Y}{mr_am}")
            else:
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam Sms Ke No {R}{mr_am}")
            time.sleep(1)
            ...
            if "neng" in buka:
                ...
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam WAKe No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "erors" in gaskeun:
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam SmsKe No {R}{mr_am}")
            else:
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam Sms Ke No {Y}{mr_am}")
            time.sleep(1)
            ...
            if "PENDING" in AmmarGamteng:
                ...
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam Sms Ke No {R}{mr_am}{R}")
            time.sleep(1)
            ...
            if "cus" in Gwganz:
                mengetik(f"{R}[{R}×{R}] Gagal Mengirim Spam SnsKe No {R}{mr_am}")
            else:
                mengetik(f"{G}[{G}✓{G}] Mengirim Spam Sms Ke No {Y}{mr_am}")
            time.sleep(2)
        ...
        sys.exit(f"{G}[{R}!{G}] Keluar!!{abu}...{W}")
    except ValueError:
        sys.exit(f"{G}[{Y}!{G}] Lu jangan asal masukin{abu}.....")
